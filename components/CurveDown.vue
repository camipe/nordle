<template>
  <div>
    ...
    <div class="text-center popuptext mb-7">
      <div class="bg-knowit-white dark:bg-blue-100 dark:text-pink-60 pt-[12vh] pb-[7vh] mx-6 rounded-[50%_50%_1.75rem_1.75rem]">
        <p class="inline text-2xl">
          <span class="block font-light text-8xl">404</span>
          Bonuspoäng
        </p>
      </div>
    </div>
