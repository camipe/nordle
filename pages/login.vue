<template>
  <div class="flex flex-col items-center justify-center h-screen font-medium bg-knowit-white-100 dark:bg-knowit-black dark:text-knowit-white-100"
    aria-labelledby="nordle-title" role="main">
    <div class="mb-12">
      <IconsNordleLogoType aria-hidden="true" />
      <h1 id="nordle-title" class="text-4xl text-center uppercase">Nördle</h1>
    ...
    <div class="flex flex-col items-start mt-12 space-y-4">
      <button @click="login" class="login-button" aria-label="Logga in med Google">
        <span class="mr-5" aria-hidden="true">
          <IconsGoogleLogoType />
        </span>
        Logga in med Google
      </button>
      <button @click="login" class="login-button" aria-label="Logga in med Apple">
        <span class="mr-5" aria-hidden="true">
          <IconsAppleLogoType />
        </span>
        Logga in med Apple
      </button>
      <button @click="login" class="login-button" aria-label="Logga in med GitHub">
        <span class="mr-5" aria-hidden="true">
          <IconsGithubLogoType />
        </span>
        Logga in med GitHub
